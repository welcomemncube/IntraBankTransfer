 ...
 *******************************************************************************/
 ...
 public class AuditListener implements MessageListener {
   ...
   private static String updateString1="update auditlog SET id=1,timestamp=";
   private static String updateString2=",details=";
   ...
   public void onMessage(Message message) {
     try {
       ...
       DataSource auditDB = InitialContext.doLookup("jdbc/auditDB");

       Connection auditConn = auditDB.getConnection();
       Statement stmt = auditConn.createStatement();
